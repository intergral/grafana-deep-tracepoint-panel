# Grafana Deep Tracepoint Panel

The Grafana Deep Tracepoint Panel is a plugin for Grafana that renders the tracepoint data that is created and stored
...
1. Build the plugin
    ...
    2. Download the latest release from [Github](https://github.com/intergral/grafana-deep-tracepoint-panel/releases)
...
1. When using the unsigned
    1. Add the line `allow_loading_unsigned_plugins = intergral-deep-tracepoint-panel,intergral-deep-datasource` to `grafana.ini` (
...
```yaml
  grafana:
    ...
    environment:
      - GF_INSTALL_PLUGINS=https://github.com/intergral/grafana-deep-tracepoint-panel/releases/download/v0.0.3/intergral-deep-panel-0.0.3.zip;intergral-deep-tracepoint-panel,https://github.com/intergral/grafana-deep-datasource/releases/download/v0.0.7/intergral-deep-datasource-0.0.7.zip;intergral-deep-datasource
    ports:
      - "3000:3000"
```
